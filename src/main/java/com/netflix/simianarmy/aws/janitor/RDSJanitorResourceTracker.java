...
public class RDSJanitorResourceTracker implements JanitorResourceTracker {
    ...
    public void addOrUpdate(Resource resource) {
    	...
    	if (orig == null) {
    		addStatement(resource, json);
    	} else {
    		updateStatement(resource, json);
    	}
    	LOGGER.debug("Successfully saved.");
    }

	private void updateStatement(Resource resource, String json) {
	...
	private void addStatement(Resource resource, String json) {
		StringBuilder sb = new StringBuilder();
